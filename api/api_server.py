...
def accept_trainer_request(request_id):
    ...
    try:
        ...
        # =====================================================
        # GET PENDING REQUEST
        # trainer_trainees is the request table
        # =====================================================
        ...
        program_plan_id = request_row["program_plan_id"]
        ...
        if not plan_days:
            ...
            return jsonify({
                "status": "error",
                "message": "No active plan days found for this split."
            }), 400

        # =====================================================
        # GET BODY PARTS FOR EACH DAY
        # =====================================================
        ...
        # GENERATE SCHEDULE
        #
        # The database cycle is followed exactly.
        #
        # Bro Split:
        # Chest
        # Back
        ...
        return jsonify({
            ...
            "message":
                "Trainer request accepted and schedule generated.",
...
def renew_member_program():
    ...
    try:
        ...
        if not current["end_date"]:
            return jsonify({
                "status": "error",
                "message": "Current trainer rate end date is missing."
            }), 400
        ...
        #
        # IMPORTANT:
        # Do NOT block simply because the current status
        # is still active.
        # =========================================================
        today = date.today()
        ...
        # =========================================================
        # BLOCK ONLY IF MORE THAN 3 DAYS REMAIN
        # =========================================================
        if days_remaining > 3:
            ...
            return jsonify({
                "status": "error",
                "message": (
                    "You can only renew your trainer rate "
        ...
        #
        # ORIGINAL START DATE STAYS THE SAME.
        #
        # Example:
        #
        # Current:
        ...
        # End    = Oct 6   <-- EXTENDED
        #
        # The renewal workout schedule itself begins
        # on Sep 30, which is the day after the old end date.
        # =========================================================
        ...
        # NEW VALID UNTIL
        #
        # ONLY EXTEND THE CURRENT END DATE.
        # =========================================================
        new_end_date = (
            old_end_date
            + timedelta(
        ...
        #
        # This is NOT the trainer_trainees start_date.
        #
        # This is only where the newly renewed workout
        # schedule begins.
        # =========================================================
        renewal_schedule_start = (
            old_end_date
            + timedelta(days=1)
        )
        ...
        # ...
        #
        # No duplicate schedules for Sep 27-29.
        # =========================================================
        if plan_days:
        ...
        return jsonify({
            ...
            "renewal_schedule_start":
                renewal_schedule_start.strftime(
                    "%Y-%m-%d"
                ),
